...
run_benchmarks() {
    ...
    $PYTHON_BIN -m pyperformance run --benchmark=2to3,docutils,html5lib,tornado_http,async_generators,float,nbody,pidigits,regex_compile,json_dumps,json_loads,pickle_list,python_startup -o $PYENV.json
}
